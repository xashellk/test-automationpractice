...
Este proyecto está basado en el repositorio de https://github.com/serenity-bdd/serenity-cucumber4-starter del cual pueden encontrar la información oficial a continuación, es importante tener en cuenta que aunque se basa en el proyecto mencionado los features nuevos si son de mi propiedad y están relacionados con la prueba solicitada.

Para ejecutar los test se debe ejecutar el comando:
+ gradle clean test -Pwebdriver.drive=chrome -Denvironment=staging
